...
import { X, Calendar, Users, Target, TrendingUp, ChevronRight, Maximize, Minimize, Heart } from "lucide-react";
...
export function CaseStudyModal({ project, isOpen, isFullscreen, onClose, onToggleFullscreen }: CaseStudyModalProps) {
      ...
      <div className="fixed inset-0 z-[9999] flex items-center justify-center">
        ...
        >
          ...
          <div className="sr-only">
            <h1 id="case-study-title">{project.title} - Case Study</h1>
            <p id="case-study-description">
              Detailed case study for {project.title} showcasing the design process, methodology, and measurable outcomes.
            </p>
          </div>
